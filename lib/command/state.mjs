...
export const commandDir = (docId) => join(paths.docs, docId, "command");
...
/**
 * One-time compaction (at 20 MB): events older than 6 h fold into one `baseline` event per front+file (their final totals)
